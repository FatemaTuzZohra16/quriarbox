    ...
    <div className='bg-section pb-[172px]'>
        <Container>
            ...
            <div className='flex justify-between'>
                {
                    data.map((item)=>(
                        <div className=' group w-[424px] bg-white rounded-[16px] pb-[49px] pt-[67px] px-[60px] hover:shadow-lg'>
                            ...
                            <div className='font-secondery font-bold text-[20px] leading-[100%] text-primary border border-primary py-[12px] px-[96px] rounded-[5px] mt-[60px] group-hover:bg-primary group-hover:text-white'>
